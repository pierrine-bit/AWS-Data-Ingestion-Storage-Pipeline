output "stream_name" {
  ...
  description = "Name of the Kinesis data stream — pass as KINESIS_STREAM_NAME env var to the producer/consumer scripts"
}
...
output "firehose_name" {
  ...
  description = "Name of the Firehose delivery stream — buffers stream records and writes GZIP files to s3://<bucket>/streaming-data/"
}
